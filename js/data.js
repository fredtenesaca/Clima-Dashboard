(function () {
  ...
  /* puede poner break point en el codigo por el if*/


  /*-----Funcion Load Inocar -------*/

  let loadInocar = () => {
  // Código de la función loadInocar
  console.log('loadInocar se ha ejecutado');
...
(() => {
  // Código de la función autoejecutable

  const loadInocar = () => {
    // Código de la función loadInocar dentro de la función autoejecutable
    console.log('loadInocar dentro de la función autoejecutable se ha ejecutado');
  };

  loadInocar(); // Llamada a la función loadInocar dentro de la función autoejecutable
})();
